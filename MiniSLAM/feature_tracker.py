...
class ORBTracker:
    def __init__(self, max_features=2000, ratio=0.8, checks=50):
    ...
    def draw_inlier_matches(self, img1, kp1, img2, kp2, matches, mask):
        ...
        return cv2.drawMatches(img1, kp1, img2, kp2, inlier_matches, None, flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)

    def update_params(self, max_features=None, ratio=None, checks=None):
